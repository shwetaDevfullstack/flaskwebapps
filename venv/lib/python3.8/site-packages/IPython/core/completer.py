...
class Completion:
    ...
    :any:`jedi.package.classes.Completion` object and the Prompt Toolkit completion
...
def rectify_completions(text: str, completions: _IC, *, _debug=False)->_IC:
    ...
    :any:`jedi.package.classes.Completion` s returned by Jedi may not have the same start and end, though
...
class IPCompleter(Completer):
    ...
    def _jedi_matches(self, cursor_column:int, cursor_line:int, text:str):
        ...
        Return a list of :any:`jedi.package.Completions` object from a ``text`` and
        cursor position.
    ...
    def _complete(self, *, cursor_line, cursor_pos, line_buffer=None, text=None,
        ...
        # FIXME: we should extend our package to return a dict with completions for
